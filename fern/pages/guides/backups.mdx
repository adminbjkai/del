...
|---|---|---|
| **None** (default) | Nothing. | Throwaway apps you are certain about; also the default for the "Complete removal" preset. Switch away from this when you may need a restore. |
